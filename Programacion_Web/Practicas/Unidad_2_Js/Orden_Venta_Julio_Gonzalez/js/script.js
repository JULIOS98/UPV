...
boton2 = document.querySelector('.btnPrueba');
boton2.addEventListener("click" ,pruebalbl);
...
function agregar()
{
    ...
    nuevo_div.setAttribute('class','nuevo');



    let nuevo_lbl = document.createElement('label');
    nuevo_lbl.innerText = '200';
    nuevo_lbl.setAttribute('class','precios');
    ...
    let padre_div = document.querySelector('.nuevo');
    padre_div.appendChild(nuevo_lbl);
    padre_div.appendChild(nuevo_input);
    padre_div.appendChild(nuevo_div);
...
function pruebalbl()
{
    ...
    let padre_div = document.querySelector('.vacio');
    padre_div.appendChild(nuevo_lbl);
